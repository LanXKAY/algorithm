...
<div><div>Related Topics</div><div><li>设计</li><li>字典树</li><li>哈希表</li><li>字符串</li></div></div><br><div><li>👍 157</li><li>👎 0</li></div>
*/
...
class MagicDictionary_676 {
    ...
    public boolean search(String searchWord) {
		...
		for (String word :
			...
			int dif = 0;
			for (int i = 0; i < Math.min(word.length(), searchWord.length()); i++) {
